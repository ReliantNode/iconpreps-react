...
export const FAQModalContext = createContext(INITIAL_STATE);

export function useFAQModal() {
  return useContext(FAQModalContext);
}
...
function LoginModal({ children }) {
  ...
  return (
    <FAQModalContext.Provider value={{ hideFAQModal, showFAQModal }}>
      {children}
      {transitions.map(
        ({ item, key, props: styles }) =>
          item && (
            <AnimatedDialogOverlay
              onDismiss={hideFAQModal}
              key={key}
              style={{ opacity: styles.opacity }}
            >
              <CloseButton type="button" onClick={hideFAQModal}>
                ...
                <Columns>
                  <Column>
                    ...
                    <Text style={{ marginTop: '2rem' }}>
                      A P-Rep is a team that you can vote for, which is working on various projects
                      that will benefit and grow the ICON eco-system.
                    </Text>
                    ...
                    <Text style={{ marginTop: '1.6rem' }}>
                      ...
                      P-Reps). They also earn rewards, which helps to fund their work. In short, a
                      vote for a P-Rep, is a vote of support for the projects they are working on.
                    </Text>
                    <Text style={{ marginTop: '2rem' }}>
                      It’s important to note that you, as the voter, earn the same amount of rewards
                      no matter what P-Rep you vote for.
                    </Text>
                  ...
                  <Column>
                    ...
                    <Text style={{ marginTop: '1.6rem' }}>
                      When you leave your rating and feedback, you’ll notice an image and name next
                      to your wallet address. This represents how much ICX you have staked — e.g.
                      “whale”. Your name is not revealed.
                    </Text>
                    <img
                      src={userLevelsImage}
